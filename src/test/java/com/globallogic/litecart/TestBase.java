    ...
    public static Stream<Product> productProvider() {
        return Stream.of(
                Product.newEntity()
                        ...
                        .withDateValidFrom("02-07-2020")
                        .withDateValidTo("10-08-2021")
                ...
                Product.newEntity()
                        ...
                        .withRubberDucks(true)
                        .withDefaultCategory("Root")
                        .withDateValidFrom("01-07-2020")
                        .withDateValidTo("09-08-2021")
                        .withManufacturer("ACME Corp.")
                        .withSupplier("")
